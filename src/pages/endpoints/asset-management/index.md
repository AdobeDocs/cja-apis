...
## Transfer user asset scenario

Use the **PUT user asset transfer** endpoint to transfer assets to a specified user. To complete an asset transfer, you will need the following:
...
### Example project transfer scenario
